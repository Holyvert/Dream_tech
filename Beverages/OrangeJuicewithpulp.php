      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Orange</p>
           
              <p class="porduct_name">Orange Juice with pulp</p>
               2.5 L
              </br>
              </br>
              <p class="price_each"id="price">7.99$</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#"> Your source of vitamin C. Not made from concentrated and 100% natural. With the pulp has a bonus
                  </a>
                  </div>
                </div>
                </br>
