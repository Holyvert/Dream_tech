      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1622543925917-763c34d1a86e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Monster</p>
           
              <p class="porduct_name">Energy Drink</p>
              400 ml
              </br>
              </br>
              <p class="price_each"id="price">4.99$</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#">  Musicians, Artists, Racers, Athletes, and more. These are high performing individual who need the energy to dominate the day. Monster Energy Drink is one of the ways that they get ahead and you can do the same too. An Energy drink wit a powerful punch and a great taste.
                  </a>
                  </div>
                </div>
                </br>
