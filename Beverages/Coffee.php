      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1551610290-e153ec567dd8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=963&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Covfefe</p>
           
              <p class="porduct_name">Coffee</p>
               930 G
              </br>
              </br>
              <p class="price_each"id="price">11.99$</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#"> Covfefe ® coffee grains are rich with a pure taste. Grown from the mountains it can make 170 cups of 150 ml. An excellent way to start the day.
                  </a>
                  </div>
                </div>
                </br>
