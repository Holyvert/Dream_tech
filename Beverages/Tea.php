      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1597066371673-2088a5c19802?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Minze</p>
           
              <p class="porduct_name">Tea</p>
               50 UN
              </br>
              </br>
              <p class="price_each"id="price">9.99$</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#"> Can help calming the day. Hot or cold service can be both enjoyed. Perfect for meditation or to start the day focused and ready.
                  </a>
                  </div>
                </div>
                </br>
