      ...
      <div class="MainPage" style=" background-color: #9b9b9b;">
            ...
            <div class="RowDescrpition">
              ...
              <input  type="hidden" name="Id" value="<?php echo $user['Id']?>">
                ...
                <p>Admin Status</p>
                <label for="Admin"><input type="radio" id="Admin" name="Admin Status" value="Admin">Admin</label>
                <label for="User"><input type="radio" id="Usesr" name="Admin Status" value="User">User</label>
