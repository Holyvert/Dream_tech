      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1596924699736-be026ddb5b0c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Maldiri</p>
           
              <p class="porduct_name">Burrata Cheese</p>
              200 G
              </br>
              </br>
              <p class="price_each"id="price">9.99$ ea.</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#">  Authentic Italian cheese. Made with imported Italian products in Canada. It can be enjoyed alone or has a side for meals.
                  </a>
                  </div>
                </div>
                </br>
