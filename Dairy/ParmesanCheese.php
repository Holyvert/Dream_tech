      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1599932677968-877d85f64a12?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=969&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">IGIANO</p>
           
              <p class="porduct_name">Parmesan Cheese</p>
              290 G
              </br>
              </br>
              <p class="price_each"id="price">11.99$ ea.</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#">  Pure, authentic, and matured Parmesan Cheese for the province of Parma. It can be eaten alone but it is usually mixed with pasta, risotto, and a variety of soups.
                  </a>
                  </div>
                </div>
                </br>
