      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1628791392322-de3fc6348d1b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Sombrero</p>
           
              <p class="porduct_name">Salsa Chips</p>
              275g
              </br>
              </br>
              <p class="price_each"id="price">3.99$</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#"> Great with salsa! Get ready for the Fiesta
                  </a>
                  </div>
                </div>
                </br>
