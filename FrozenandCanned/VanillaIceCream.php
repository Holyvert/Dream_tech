      ...
      <div class="MainPage">
          ...
          <div class="RowDescrpition" >
            ...
            <div class="imgDescription"  > 
              ...
              <img src="https://images.unsplash.com/photo-1628815870980-f416105d89b3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="" class="images">
            </div>
  
            <div class="ProductDescription">
           
              <p class="compagny">Darrell's</p>
           
              <p class="porduct_name">Vanilla Ice Cream</p>
              1.5L
              </br>
              </br>
              <p class="price_each"id="price">6.19$</p>
                ...
                <div class="dropdown">
                  ...
                  <a href="#"> The most creamy and rich ice cream you can find. Treat yourself after a workout, with your family and friends, or just to relax on a "sundae" night!
                  </a>
                  </div>
                </div>
                </br>
